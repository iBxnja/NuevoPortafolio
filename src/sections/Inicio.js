        ...
        <section id="#inicio" class="w-10/12 h-full flex-col bg-black flex items-center justify-center text-white">
            <div class="2xl:w-full xl:w-full lg:w-full h-full flex items-center justify-center text-white mt-20">
                <div class="w-6/12 cel:w-full sm:w-full sm:h-full sm:items-center cel:h-full h-full flex items-start gap-3 justify-center flex-col font-bold cel:items-center">
                    ...
                    <h2 class="text-start text-7xl cel:text-4xl sm:text-4xl">HOLA</h2>
                    <h2 class="text-start text-7xl cel:text-4xl sm:text-4xl">SOY BENJAMIN</h2>
                    <h2 class="text-start text-7xl cel:text-4xl sm:text-4xl">PROGRAMADOR</h2>
                    <h2 class="text-start text-7xl cel:text-4xl sm:text-4xl">FULL STACK</h2>
                    ...
                    <a href={BenjaminVallory} download="BenjaminVallory.jpg" class="transition duration-200 ease-in-out hover:bg-teal-400 hover:text-black w-72 h-16 grid place-items-center cel:mt-10 mt-20 border-2 border-teal-400 font-medium">DESCARGAR CV</a>
                    </div>
                </div>
